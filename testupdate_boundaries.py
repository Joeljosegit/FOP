...
def main():
    ...
    for timestep in range(10):
        ...
        for c in creatures:
                ...
                c.boundaries(creatures) #5.2.1 - ensures that none of the creatures go into any fences or gates or off the grid
                c.terrain_change(creatures,friends,creatures_house,friends_house) #5.1.5 - Changes terrain if a character is at the doorway into house and they enter into the house grid
                c.plot_me(ax[0],size)
        ...
        for ch in creatures_house:
            ...
            ch.house_boundaries(creatures_house) #5.2.2 - makes sure none of the creatures in the house, don't go into any walls or into the TV
