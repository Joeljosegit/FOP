...
def main():
    ...
    toys_house.append(Toy("Ball","red",(30,10), True))
    ...
    for timestep in range(10):
        ...
        for c in creatures:
                ...
                c.chase(creatures,strangers,friends)
        ...
        for t in toys:
            t.plot_me(ax[0],size)
        for th in toys_house:
            th.plot_me(ax[3],size)
        for f in foods:
        ...
        for ch in creatures_house:
            ...
            ch.plot_hunger_boredom(creatures_house,ax[2])
